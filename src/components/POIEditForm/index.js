...
import { Button, Modal, ModalHeader, ModalBody, Label, Col, Form, FormGroup, Input, TabContent, TabPane, Nav, NavItem, NavLink, Card, CardTitle, CardImg, CardBody, CardGroup, CardSubtitle, CardText, Row } from 'reactstrap';
    ...
    loadImage() {
        ...
        if (this.state.isModalOpen) {
            ...
            return this.state.imageList.map(image => 
                ...
                <div key={image.split("token=")[1]} className="col-12 col-md-5 m-1 d-flex align-self-stretch">
                    <Card>
                        <CardImg top width="100%" max-height="186px" src={image}  alt="Card image cap" onClick={() => this.toggleFile(image)}/>
